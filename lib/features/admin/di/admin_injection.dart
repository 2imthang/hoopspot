...
/// Dùng lại [AuthRepository]/[CourtRepository] (đã đăng ký ở
/// [initAuthDependencies]/[initCourtDependencies]) cho mọi thao tác trên
/// `users`/`courts` — Admin chỉ là một góc nhìn/khả năng khác trên cùng dữ
/// liệu đó, không cần datasource/repository riêng.
